...
def logo():
    ...
    st.sidebar.markdown(f'''[<img class="img1" src='data:image/png;base64,{img_to_bytes("src/Everyday_SQL/style/everyday_sql.png")}'>](https://Tushar-Aggarwal.com/)''', unsafe_allow_html=True)
